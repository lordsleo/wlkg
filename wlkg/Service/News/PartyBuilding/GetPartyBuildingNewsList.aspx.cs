...
{
    public partial class GetPartyBuildingNewsList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (pages == null || filter == null)
                {
                    ...
                    arry[0] = "举例：http://218.92.115.55/wlkg/Service/News/PartyBuilding/GetPartyBuildingNewsList.aspx?UserId=&Pages=1&Filter=";
