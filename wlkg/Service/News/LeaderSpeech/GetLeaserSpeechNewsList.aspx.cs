//
//文件名：    GetLeaserSpeechNewsList.aspx.cs
//功能描述：  获取领导讲话新闻列表
//创建时间：  2015/07/06
//作者：      
//修改时间：  暂无
...
namespace wlkg.Service.News.LeaderSpeech
{
    public partial class GetLeaserSpeechNewsList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (pages == null || filter == null)
                {
                    ...
                    arry[0] = "举例：http://218.92.115.55/wlkg/Service/News/LeaderSpeech/GetLeaserSpeechNewsList.aspx?UserId=&Pages=1&Filter=";
