//
//文件名：    GetCompanyIssuingNewsList.aspx.cs
//功能描述：  获取公司发文新闻列表
//创建时间：  2015/07/07
//作者：      
//修改时间：  暂无
...
{
    public partial class GetCompanyIssuingNewsList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (pages == null || filter == null)
                {
                    ...
                    arry[0] = "举例：http://218.92.115.55/wlkg/Service/News/CompanyIssuing/GetCompanyIssuingNewsList.aspx?UserId=&Pages=1&Filter=";
