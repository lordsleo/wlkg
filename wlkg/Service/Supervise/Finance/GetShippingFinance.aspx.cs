//
//文件名：    GetShippingFinance.aspx.cs
//功能描述：  获取船务财务数据
//创建时间：  2015/07/09
//作者：      
//修改时间：  暂无
...
{
    public partial class GetShippingFinance : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (startTime == null || endTime == null)
                {
                    ...
                    arry0[0] = "举例：http://218.92.115.55/wlkg/Service/Supervise/Finance/GetShippingFinance.aspx?StartTime=2015-01-01 00:00:00&EndTime=2015-07-09 00:00:00";
