//
//文件名：    GetFeightFinanceDetail.aspx.cs
//功能描述：  获取货运财务明细数据
//创建时间：  2015/07/09
//作者：      
//修改时间：  暂无
...
{
    public partial class GetFeightFinanceDetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    info.Add("参数StartTime，EndTime，ID不能为nul！", "举例：http://218.92.115.55/wlkg/Service/Supervise/Finance/GetFeightFinanceDetail.aspx?StartTime=2015-01-01&EndTime=2015-07-09&ID=1");
                ...
                info.Add("货名", dt.Rows[rowNum]["CargoName"].ToString());
                info.Add("提单数量", dt.Rows[rowNum]["BlnoAmount"].ToString());
                info.Add("水尺数量", dt.Rows[rowNum]["DraftAmount"].ToString());
                info.Add("应付人民币总额", dt.Rows[rowNum]["PayRMBAmounts"].ToString());
                info.Add("应收人民币总额", dt.Rows[rowNum]["ReceiveRMBAmounts"].ToString());
                info.Add("时间", dt.Rows[rowNum]["DTime"].ToString());
                info.Add("部门", dt.Rows[rowNum]["DeptName"].ToString());
